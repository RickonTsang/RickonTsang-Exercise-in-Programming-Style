...
// over write the apply method for each Function
class Ten {
	public static class TheOne{
		Object value;
		public TheOne(Object value){
			this.value = value;
		}

		public TheOne bind(Function func){
	...
	private static class readFile implements Function<String, String> {
		@Override
	...
	private static class filterCharsAndNormalize implements Function<String, String> {
		@Override
	...
	private static class removeStopWords implements Function<String, List<String>> {
		@Override
	...
	private static class frequencies implements Function<List<String>, Map<String, Integer>> {
		@Override
	...
	private static class sortAndPrint implements Function<Map<String, Integer>, List<String>>{
		@Override
		public List<String> apply(Map<String, Integer> wordFreqs) {
	...
	public static void main(String[] args) {
		...
		new TheOne(args[0])
			.bind(new readFile())
			.bind(new filterCharsAndNormalize())
			.bind(new removeStopWords())
			.bind(new frequencies())
			.bind(new sortAndPrint())
			.print();
	}
}